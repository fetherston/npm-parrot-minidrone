...
class Drone extends EventEmitter {
     ...
     * @param {Boolean} options.maxAltitude The max height in meters the drone can reach
     * @param {Boolean} options.maxTilt The max tilt the drone can achieve from 0-100 (100 being the max 20° inclination the drone firmware allows)
