...
class Drone extends EventEmitter {
    ...
    /**
     * Sets the drone's light state
     * @param {string} state The desired light state, can be flash, blink, or oscillate
     * @return {undefined}
     */
    animateHeadlights(animation) {
        this.network.writeHeadlightAnimation(animation);
    }
