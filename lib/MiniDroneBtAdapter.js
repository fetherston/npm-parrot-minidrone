...
const CHARACTERISTIC_MAP = [
    ...
    /*'fb00','fb01','fb02','fb03','fb04','fb05','fb06','fb07','fb08','fb09','fb0a','fb0b','fb0c','fb0d',
    'fb10','fb11','fb12','fb13','fb14','fb15','fb16','fb17','fb18','fb19','fb1a','fb1d','fb1e','fb1f',
    'fe01','fe02',*/
];
...
class MiniDroneBtAdapter extends EventEmitter {
    ...
    /**
     * Convenience method for settings the drone's altitude limitation
     * @param  {Integer} altitude the altitude in meters between 2m-10m
     * @return {undefined}
     */
    writeMaxAltitude(altitude) {
        ...
        buffer.writeInt16LE(2, 2);
        buffer.writeInt16LE(8, 3); // cmd class
        buffer.writeInt16LE(0, 4); // cmd method
        buffer.writeInt16LE(0, 5);
        buffer.writeFloatLE(altitude, 6);
     ...
     * @param  {integer} tilt The max tilt from 0-100 (0 = 5° - 100 = 25°)
     * @return {undefined}
     */
    writeMaxTilt(tilt) {
        const buffer = new Buffer(19);
        ...
        buffer.writeInt16LE(2, 2);
        buffer.writeInt16LE(8, 3); // cmd class
        buffer.writeInt16LE(1, 4); // cmd method
        buffer.writeInt16LE(0, 5);
        buffer.writeFloatLE(tilt, 6);
        buffer.writeInt16LE(0, 7);
        this.write(COMMAND_KEY, buffer);
        this.emit('maxTiltChange', tilt);
        Logger.info(`Setting max tilt to ${tilt} degrees`);
    }
    ...
    writeMaxVerticalSpeed(verticalSpeed) {
        ...
        buffer.writeInt16LE(++this.steps[COMMAND_KEY], 1);
        buffer.writeInt16LE(2, 2);
        buffer.writeInt16LE(1, 3); // cmd class
        buffer.writeInt16LE(0, 4); // cmd method
        buffer.writeInt16LE(0, 5);
        buffer.writeFloatLE(verticalSpeed, 6);
        buffer.writeInt16LE(0, 7);
        this.write(COMMAND_KEY, buffer);
        this.emit('maxVeticalSpeedChange', verticalSpeed);
     ...
     * @param  {integer} tilt The max rotation speed from 0-1000 (50°/s - 360°/s)
     * @return {undefined}
     */
    writeMaxRotationSpeed(rotationSpeed) {
        ...
        buffer.writeInt16LE(1, 4); // cmd method
        buffer.writeInt16LE(0, 5);
        buffer.writeFloatLE(rotationSpeed, 6);
        buffer.writeInt16LE(0, 7);
        this.write(COMMAND_KEY, buffer);
